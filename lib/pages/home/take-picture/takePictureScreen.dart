...
import '../../notifDisplay/diseaseDisplay.page.dart';
...
class _TakePictureScreenState extends State<TakePictureScreen> {
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () async {
          ...
          try {
            ...
            var res = await _sendRequestModelAPI(image.path);

            await Navigator.of(context).pushAndRemoveUntil(
              MaterialPageRoute(
                builder: (context) => DiseaseDisplay(
                  data: DiseaseModel(res["class"], image.path, 0),
                ),
              ),
  ...
  Future<dynamic> _sendRequestModelAPI(String path) async{
    var request = http.MultipartRequest('POST',
        Uri.parse('http://164.92.118.194:5000/predict'));
